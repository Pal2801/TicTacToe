...
public class TicTacToe {
    ...
    JButton replayButton = new JButton("Replay"); // New replay button
    String playerX = "X";
    String playerO = "O";
    ...
    TicTacToe() {
        ...
        replayButton.setBackground(Color.darkGray);  
        ...
        textPanel.add(replayButton, BorderLayout.EAST); // Add replay button to the text panel
    ...
    // Reset method for the replay button
    void resetGame() {
        for (int r = 0; r < 3; r++) {
            for (int c = 0; c < 3; c++) {
                board[r][c].setText("");
